...
one directory of files, live at `https://<host>/pages/<identity>/<slug>/`.
...
| `404` | request path wrong | publish to `POST /pages/<slug>`; check the base URL |
