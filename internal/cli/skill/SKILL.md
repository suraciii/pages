...
The Public Root and each Named Identity root provide a static Page Index that
links to the currently published Pages. It is generated by the service and
Publisher; no extra command is required.
